...
class OpenClassrooms extends Scraper {
	...
	constructor() {
		...
		this.selectors = {
			...
			brief: "//*[@id='mainContent']/article/div[3]/div/div/div/div[2]/div/section/div/div[1]/p",
			duration:
	...
	switchSelectors(type) {
		if (type === "path") {
			this.selectors = {
				...
				altProgramme2:
					'//*[@id="path_details_description"]/div/div/ul[1]',
				animateur:
